...
public class Test
{
    private static String path1 = Test.class.getClassLoader().getResource("").getPath() + "com" + File.separator
                                        + "hnmmli" + File.separator + "g2base" + File.separator + "mybatis"
        ...
        for (String s : classNames)
        {
            ...
            for (Field f : fields)
            {
                        ...
                        && !f.getType().equals(long.class) && !f.getType().equals(List.class))
                {
                    ...
                    fieldNames.add(new KeyValue(f.getType().getName()
                            .replace("com.hnmmli.g2base.mybatis.entities.", ""), -1));
                }
            }
