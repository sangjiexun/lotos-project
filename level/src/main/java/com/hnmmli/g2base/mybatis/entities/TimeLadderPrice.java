...
public class TimeLadderPrice implements Serializable {
    ...
    private BigDecimal fluctuactionPrice;
    ...
    public BigDecimal getFluctuactionPrice() {
        return fluctuactionPrice;
    }

    public void setFluctuactionPrice(BigDecimal fluctuactionPrice) {
        this.fluctuactionPrice = fluctuactionPrice;
    }
