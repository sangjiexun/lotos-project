 ...
 * 
 */
@WebServiceClient(name = "WarehouseService", targetNamespace = "http://websericve.javacore.distributed.hnmmli.com/", wsdlLocation = "http://localhost:8080/WebServices/warehouse?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WAREHOUSESERVICE_QNAME = new QName("http://websericve.javacore.distributed.hnmmli.com/", "WarehouseService");
    ...
    public Warehouse getWarehousePort() {
        return super.getPort(new QName("http://websericve.javacore.distributed.hnmmli.com/", "WarehousePort"), Warehouse.class);
    }
    ...
    public Warehouse getWarehousePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://websericve.javacore.distributed.hnmmli.com/", "WarehousePort"), Warehouse.class, features);
    }
