...
public class DH_Encryption extends BaseEncryption
{
     ...
     * 
     * 场景一：
     * 甲方使用私钥，乙方公钥，约定加密算法构建本地密钥
     * 甲方使用本地密钥对数据加密
     * 甲方向乙方发送加密数据
     * 乙方使用私钥，甲方公钥，约定加密算法 构建本地密钥
     * 乙方使用本地密钥解密数据
     * 
     * 场景二：
     * 反之亦然
    ...
    {
        // 初始化公钥
        byte[] pubKeyBytes = decryptByApacheBASE64(publicKey);
        ...
        // 初始化私钥
        byte[] priKeyBytes = decryptByApacheBASE64(privateKey);
