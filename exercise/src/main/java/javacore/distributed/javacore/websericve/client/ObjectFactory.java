 ...
 * generated in the javacore.distributed.javacore.websericve.client package.
 * <p>
...
public class ObjectFactory
{
    ...
    private final static QName _GetPrice_QNAME         = new QName("http://websericve.javacore.distributed.javacore/",
                                                               "getPrice");

    private final static QName _GetPriceResponse_QNAME = new QName("http://websericve.javacore.distributed.javacore/",
                                                               "getPriceResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package:
     * javacore.distributed.javacore.websericve.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://websericve.javacore.distributed.javacore/", name = "getPrice")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://websericve.javacore.distributed.javacore/", name = "getPriceResponse")
