package javacore.local.javacore.retire;
...
public class Retire extends JApplet
{
    ...
    public void setCurrentLocale(Locale locale)
    {
        ...
        /* 读取配置文件 其中包要指向全路径 */
        this.res = ResourceBundle.getBundle("javacore.local.javacore.retire.RetireResources", this.currentLocale);
        this.resStrings = ResourceBundle
                .getBundle("javacore.local.javacore.retire.RetireStrings", this.currentLocale);
