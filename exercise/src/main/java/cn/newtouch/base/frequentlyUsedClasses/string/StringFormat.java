...
public class StringFormat
{
     ...
     * 
     * %[index$][标识][最小宽度][保留精度]转换方式 (保留小数点强于最小宽度)
     */
    public static void formatFloat()
    {
        // 保留小数点强于最小宽度
        System.out.println(String.format("%1$,020.10f", 123123123123.123456789123123));
    ...
    public static void formatDate()
    {
        ...
        long intt = date.getTime();

        System.out.println(String.format("%1$tF %1$tT", intt));
    ...
    /**
     * 规转换可应用于任何参数类型
     * 'b或B' '\u0062' 将生成 "true" 或 "false"， 如果参数为 null，则结果为 "false"。如果参数是一个 boolean 值或 Boolean，那么结果是由 String.valueOf()
     * 返回的字符串。否则结果为 "true"。
     * 'h或H' '\u0068' 生成一个表示对象的哈希码值的字符串。 如果参数 arg 为 null，则结果为 "null"。否则，结果为调用 Integer.toHexString(arg.hashCode()) 得到的结果。
     * 's或S' '\u0073' 生成一个字符串。 如果参数为 null，则结果为 "null"。如果参数实现了 Formattable，则调用其 formatTo 方法。否则，结果为调用参数的 toString()
     * 方法得到的结果。
     * 
     * 
     */
    public static void formatAny()
    {
        ...
        System.out.println(String.format(pattern, "明明", "芳芳", 10000, System.currentTimeMillis()));
    }

    public static void main(String[] args)
    {
        // System.out.println("=====formatAny()=====");
        formatAny();
        // System.out.println("====================");
        ...
        // System.out.println("=====formatChar()=====");
        // formatChar();
        // System.out.println("====================");

        // System.out.println("=====formatBaiFenBi()=====");
        // formatBaiFenBi();
        // System.out.println("====================");
