...
public class Constants
{
    ...
    // 坦克方向:右
    public static final int   TANK_RIGHT      = 3;

    // 坦克方向:下
    public static final int   TANK_DOWN       = 4;

    // 坦克方向:左上
    public static final int   TANK_LEFT_UP    = 5;

    // 坦克方向:右上
    public static final int   TANK_RIGHT_UP   = 6;

    // 坦克方向:右下
    public static final int   TANK_RIGHT_DOWN = 7;

    // 坦克方向:左下
    public static final int   TANK_LEFT_DOWN  = 8;

    // 坦克方向:停止
    public static final int   TANK_STOP       = 0;
