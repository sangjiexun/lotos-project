...
public class Constants
{
    public static enum Direction {
        LEFT, UP, RIGHT, DOWN, LEFT_UP, RIGHT_UP, RIGHT_DOWN, LEFT_DOWN,
    }
    ...
    // 子弹伤害
    public static final int   MISSILE_HIT         = 10;

    // 坦克伤害
    public static final int   TANK_HIT            = 30;

    // 敌方坦克生命值
    public static final int   TANK_LIFE           = 20;

    // 
    public static final int   TANK_BOOLD_HEIGHT   = 10;
    ...
    // 坦克颜色
    public static final Color TANK_COLOR          = Color.BLUE;

    // 
    public static final Color TANK_BOOLD_COLOR    = Color.RED;

    // 坦克颜色
    public static final Color TANK_COLOR_OTHER    = Color.YELLOW;

    // 炮筒默认颜色
    public static final Color BARREL_COLOR        = Color.BLACK;

    // 炮弹默认颜色
    public static final Color MISSILE_COLOR       = Color.BLACK;

    // 炮弹默认颜色
    public static final Color MISSILE_COLOR_OTHER = Color.WHITE;
