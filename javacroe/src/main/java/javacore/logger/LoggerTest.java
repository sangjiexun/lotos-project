...
{
    // 第二参数指包名+文件名去掉".properties",比如需要找该类同一个包下的logger.properties文件 则该参数为'javacore.logger.logger'
    private static Logger logger = Logger.getLogger("javacore.logger.LoggerTest", "logger");
