...
public class BCELTiming
{
    ...
    {
        String classUrl = "G:\\eclipse\\workspace\\exercise\\target\\classes\\javacore\\chapter11\\bcel_online\\StringBuilder.class";
        String methodName = "buildString";
        String targetClassfile = "G:\\classpath\\javacore\\chapter11\\bcel_online\\StringBuilder.class";
        try
        {
