...
public class StreamTest
{
    ...
    {
        String path = URLDecoder.decode(StreamTest.class.getClassLoader().getResource("./javacore/stream/流学习test.txt")
                .getPath(), "UTF-8");
    ...
    {
        File f = new File("G:\\eclipse\\workspace\\exercise\\target\\classes\\javacore\\stream\\流学习out_test.txt");
    ...
    {
        File f = new File("G:\\eclipse\\workspace\\exercise\\target\\classes\\javacore\\stream\\流学习write_test.txt");
