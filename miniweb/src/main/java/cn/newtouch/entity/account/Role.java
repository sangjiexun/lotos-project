package cn.newtouch.entity.account;
...
import cn.newtouch.entity.IdEntity;
...
public class Role extends IdEntity
{
    ...
    {
        return ConvertUtils.convertElementPropertyToString(this.authorityList,
                "name", ", ");
    }
    ...
    {
        return ConvertUtils.convertElementPropertyToList(this.authorityList,
                "id");
    }
