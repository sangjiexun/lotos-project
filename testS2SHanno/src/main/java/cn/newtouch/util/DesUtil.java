...
public class DesUtil
{
     ...
     * @throws Exception
     */
    public static void desCrypt(String file, String dest, String password)
            throws Exception
    {
        Cipher cipher = Cipher.getInstance("DES");
        SecretKeyFactory keyFactory = SecretKeyFactory.getInstance("DES");
     ...
     * @throws Exception
     */
    public static void decrypt(String file, String dest, String password)
            throws Exception
    {
        Cipher cipher = Cipher.getInstance("DES");
        SecretKeyFactory keyFactory = SecretKeyFactory.getInstance("DES");
     ...
     * @return
     */
    public static String generateAuthCode(String kaociCode,String changciCode,String kaochangCode,String itemCode,String key){
    	...
    	for(int i=0;i <key.length();i++){ 
    		sb.append(String.valueOf(((int)key.charAt(i))%10));
    		
    		System.out.println(" <br> "+key.substring(i,i+1)+ "--> asc== "+(int)key.charAt(i))   ; 
    		System.out.println( " <br> "+(int)key.charAt(i)+ "--> asc== "+(char)((int)key.charAt(i)))   ;
    	}
    ...
    {
    	generateAuthCode("0002","00040009","0004007008","2","3393e222");
