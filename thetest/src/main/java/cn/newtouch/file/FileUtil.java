...
public class FileUtil
{
     ...
     * @throws Exception
     */
    public static void zipFileNoBaseFolder(String basePath, String zipname) throws Exception
    {
     ...
     * @throws Exception
     */
    public static void zipFile(List<File> zipFiles, String zipname) throws Exception
    {
        ZipEntry ze = null;
     ...
     * @throws Exception
     */
    public static void unZipFlie(String parentPath, String file) throws Exception
    {
     ...
     * @throws Exception
     */
    public static void unZipFlie(String parentPath, File upload) throws Exception
    {
     ...
     * @since 2012-03-27修改
     */
    public static void saveFile(String namePath, File upload) throws IOException
    {
