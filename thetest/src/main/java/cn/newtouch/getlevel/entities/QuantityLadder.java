...
public class QuantityLadder implements Serializable {
    ...
    private BigDecimal flactuactionPriceUnit;
    ...
    public BigDecimal getFlactuactionPriceUnit() {
        return flactuactionPriceUnit;
    }

    public void setFlactuactionPriceUnit(BigDecimal flactuactionPriceUnit) {
        this.flactuactionPriceUnit = flactuactionPriceUnit;
    }
